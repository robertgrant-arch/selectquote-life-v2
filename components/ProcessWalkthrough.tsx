...
const steps = [
  {
    ...
    time: '5 minutes',
    desc: 'Answer a few basic questions about yourself, your family, and what you\u2019re looking for. You can use our AI guide online or speak with a licensed agent by phone.',
    details: 'We\u2019ll ask about your age, health history, tobacco use, coverage goals, and budget. Nothing invasive\u2014just enough to start matching you with carriers.',
  },
  {
    num: '2',
    ...
    details: 'Unlike going to one carrier directly, we shop the entire market on your behalf. This means you see competitive options you\u2019d never find on your own.',
  },
  {
    num: '3',
    ...
    details: 'No pressure, no hard sell. If you need time to think or want to adjust your coverage amount, we\u2019re here when you\u2019re ready.',
  },
  {
    num: '4',
    ...
    details: 'You\u2019ll confirm your personal information, health history, beneficiaries, and coverage details. Your agent handles the paperwork.',
  },
  {
    num: '5',
    ...
    details: 'If a medical exam is needed, a licensed professional comes to you at no cost. They\u2019ll take basic measurements, blood pressure, and a blood/urine sample. Results go directly to the carrier.',
  },
  {
    num: '6',
    ...
    details: 'Your agent reviews the final policy with you to make sure everything matches what you selected. You\u2019ll name your beneficiaries and set up payment.',
  },
];

const myths = [
  { myth: '\"Life insurance is too expensive.\"', reality: 'A healthy 30-year-old can often get $500K in term coverage for under $25/month. It\u2019s typically much less than people expect.' },
  { myth: '\"I\u2019m too young to need it.\"', reality: 'The younger and healthier you are, the lower your rates. Locking in coverage early can save you thousands over time.' },
  ...
  { myth: '\"The medical exam is a dealbreaker.\"', reality: 'Many carriers now offer no-exam policies with instant or same-day approval. And if an exam is required, it\u2019s free and done at your home.' },
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">
            The life insurance process can feel like a mystery. Here\u2019s exactly what to expect, step by step.
          </p>
        </div>
        ...
        <div className="mt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Let\u2019s clear up the most common misconceptions that keep people from getting coverage.
            </p>
          </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-[#e8722a]/10 to-transparent border border-[#e8722a]/20 rounded-2xl p-8 max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-3">Ready to see what\u2019s available for you?</h3>
