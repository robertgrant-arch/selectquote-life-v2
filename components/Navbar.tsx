        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a href="#" className="text-gray-300 hover:text-white text-sm">Life Insurance</a>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={openModal}
              className="bg-[#e8722a] hover:bg-[#d4611f] text-white px-5 py-2 rounded-full text-sm font-semibold transition-colors"
            >
              Get Free Quote
            </button>
          </div>
