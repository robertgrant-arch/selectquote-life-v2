    ...
    <section id="testimonials" className="py-20 bg-[#0f2a4a]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4"><strong className="text-white">4.8</strong> on Trustpilot &middot; 40,000+ reviews</p>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          {reviews.map((r, i) => (
            <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-8">
              <div className="flex text-[#f5a623] mb-4">{String.fromCharCode(9733).repeat(5)}</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">{r.loc} &middot; {r.policy}</div>
                </div>
              </div>
            </div>
          ))}
